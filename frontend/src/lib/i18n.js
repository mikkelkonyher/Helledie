...
const translations = {
  da: {
    ...
    'about.story.text': 'Ole Helledie er den DJ, du får, når du blander en kunstnerisk mor, en DJ-datter og en flok Mercantec-elever, der konstant presser ham til at være bedre. Resultatet? Musik, events og historier, der ikke altid giver mening – men som altid får folk til at danse.',
  ...
  en: {
    ...
    'about.story.text': 'Ole Helledie is the DJ you get when you mix an artistic mother, a DJ daughter, and a bunch of Mercantec students constantly pushing him to be better. The result? Music, events, and stories that don’t always make sense — but always get people dancing.',
