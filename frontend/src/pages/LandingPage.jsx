                ...
                <div className="w-full max-w-6xl mx-auto">
                    ...
                    <div className="hidden md:flex items-center justify-center gap-8">
                        ...
                        <div className="relative group">
                            ...
                            >
                                {/* Mixer Panel */}
                                <div className="absolute inset-6 bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl shadow-inner p-8">
                                    {/* DJ Logo */}
                                    ...
                                    <div className="grid grid-cols-3 gap-4 mb-6">
                                        {[...Array(3)].map((_, i) => (
                                            <div key={i} className="flex flex-col items-center">
                                                {/* Knob */}
                                                <div className="w-8 h-8 bg-gray-600 rounded-full shadow-inner mb-2 group-hover:bg-indigo-500 transition-colors duration-300"></div>
                                                {/* Fader Track */}
                                    ...
                                    <div className="flex justify-center gap-4">
                                        {[...Array(2)].map((_, i) => (
                                            <div
                                                key={i}
                                                className="w-6 h-6 bg-gray-600 rounded-full shadow-inner group-hover:bg-purple-500 transition-colors duration-300"
                                            ></div>
                                        ))}
                                    </div>
                                    {/* Glow Effect */}
                                ...
                                {/* Label */}
                                <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 text-center">
                                    <p className="text-indigo-400 font-semibold text-lg">DJ Ole Helledie</p>
                                    <p className="text-gray-400 text-sm">Om</p>
                                </div>
                            </Link>
                        </div>
                                ...
                                <div className="absolute inset-6 rounded-full bg-gradient-to-br from-gray-700 to-gray-800 shadow-inner">
                                    <div className="absolute inset-6 rounded-full overflow-hidden">
                                        <img
                                            ...
                                            className="w-full h-full object-cover rounded-full group-hover:animate-spin transition-all duration-1000"
                                        />
                                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-gray-900 rounded-full">
                            ...
                            >
                                <div className="absolute inset-6 bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl shadow-inner p-6">
                                    ...
                                    <div className="flex flex-col items-center h-full justify-center gap-4">
                                        {/* DJ Logo */}
                                        <div className="w-16 h-16 bg-gradient-to-br from-gray-900 to-black rounded border border-indigo-400/40 shadow-lg flex items-center justify-center">
                                            <div className="text-indigo-300 font-light text-sm tracking-wide" style={{ fontFamily: 'serif' }}>DJ</div>
                                        </div>
                                        {/* Mini Faders */}
